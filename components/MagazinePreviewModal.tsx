...
function AtlasSVG() {
  return (
    ...
    >
      ...
      {/* continents */}
      <g fill="#2A211B" opacity="0.78">
        <path d="M 130 90 Q 100 80 90 110 Q 80 140 110 170 Q 130 200 165 220 Q 190 240 220 235 Q 250 230 260 200 Q 270 170 260 145 Q 270 125 285 120 Q 290 100 270 92 Q 240 80 200 78 Q 165 78 130 90 Z" />
        <path d="M 220 240 Q 235 250 240 260 Q 250 270 255 280 L 265 295 Q 260 305 250 305 Q 240 300 230 285 Q 220 270 215 255 Z" />
        <path d="M 270 305 Q 260 310 255 330 Q 250 360 265 395 Q 280 425 295 430 Q 310 432 320 410 Q 325 380 320 350 Q 318 325 305 308 Q 290 300 270 305 Z" />
        <path d="M 320 60 Q 310 55 305 70 Q 305 90 315 100 Q 325 102 335 92 Q 340 75 330 62 Z" />
        <path d="M 475 110 Q 465 105 460 120 Q 458 135 470 145 Q 485 150 500 145 Q 515 140 525 130 Q 530 115 520 108 Q 505 100 490 105 Q 480 108 475 110 Z" />
        <path d="M 458 105 Q 452 100 450 110 Q 450 120 458 125 Q 465 125 467 115 Q 467 105 458 105 Z" />
        <path d="M 510 75 Q 500 70 498 90 Q 500 105 515 108 Q 525 100 528 85 Q 525 72 510 75 Z" />
        <path d="M 480 160 Q 465 165 460 185 Q 455 210 465 235 Q 475 265 490 285 Q 510 305 525 305 Q 545 300 555 285 Q 565 265 560 240 Q 555 215 545 195 Q 538 175 525 165 Q 510 158 495 158 Q 485 158 480 160 Z" />
        <path d="M 570 270 Q 565 275 568 290 Q 572 300 580 298 Q 582 285 578 272 Q 575 268 570 270 Z" />
        <path d="M 555 175 Q 545 178 545 195 Q 548 210 562 215 Q 575 212 582 200 Q 585 185 575 175 Q 565 172 555 175 Z" />
        <path d="M 540 80 Q 525 75 530 95 Q 535 110 555 115 Q 575 110 595 115 Q 620 110 650 115 Q 690 110 720 105 Q 760 105 790 115 Q 815 120 820 105 Q 815 85 790 75 Q 750 65 700 65 Q 650 65 600 70 Q 565 75 540 80 Z" />
        <path d="M 585 120 Q 575 125 580 145 Q 585 160 605 165 Q 625 165 645 160 Q 665 155 680 145 Q 685 130 680 122 Q 660 115 635 118 Q 605 118 585 120 Z" />
        <path d="M 650 165 Q 640 170 645 195 Q 650 215 665 225 Q 678 220 680 200 Q 682 180 675 168 Q 660 162 650 165 Z" />
        <path d="M 720 170 Q 710 180 715 200 Q 720 215 735 215 Q 745 210 745 195 Q 745 180 735 170 Z" />
        <path d="M 740 230 Q 738 233 745 235 Q 755 236 760 232 Q 757 228 750 228 Z" />
        <path d="M 770 235 Q 768 238 778 240 Q 790 240 793 235 Q 788 232 780 232 Z" />
        <path d="M 803 240 Q 800 245 812 247 Q 820 245 822 240 Q 815 237 808 238 Z" />
        <path d="M 820 130 Q 815 135 822 150 Q 830 155 835 145 Q 838 132 830 127 Q 823 127 820 130 Z" />
        <path d="M 780 280 Q 760 285 758 305 Q 762 325 785 335 Q 815 340 840 330 Q 855 320 855 300 Q 850 285 825 280 Q 800 278 780 280 Z" />
        <path d="M 880 340 Q 875 345 880 358 Q 885 365 892 360 Q 895 350 890 342 Z" />
      </g>
